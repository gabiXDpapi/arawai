  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-slate-50 relative overflow-hidden px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute top-6 left-6 sm:top-10 sm:left-10 z-20">
        <Link 
          href="/" 
          className="group flex items-center gap-3 text-slate-500 hover:text-emerald-600 font-bold transition-all duration-300"
        >
          <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-white shadow-sm border border-slate-200 group-hover:border-emerald-500 group-hover:shadow-emerald-200/50 group-hover:shadow-xl transition-all active:scale-90">
